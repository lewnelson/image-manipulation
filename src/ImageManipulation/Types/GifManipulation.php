...
/**
 * This file is part of the lewnelson/image-manipulation package.
 *
...
class GifManipulation extends ImageManipulationBase implements ImageManipulationInterface
{
    ...
    public function generateThumbnail($options = array())
    {
        ...
        $resource_function = 'imagecreatefromgif';
        ...
        $source_image = imagecreatefromgif($this->file_info->getRealPath());
        ...
        imagegif($virtual_image, $new_path);
        return new \SplFileInfo($new_path);
    }
